...
{
    public partial class sdfb123df : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomFacilitiess", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomFacilitiess_Rooms_RoomId1",
                        column: x => x.RoomId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomFacilitiess_RoomId1",
                table: "RoomFacilitiess",
                column: "RoomId1");
        }
